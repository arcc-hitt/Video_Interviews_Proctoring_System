...
export const useAlertStreaming = (options: UseAlertStreamingOptions): UseAlertStreamingReturn => {
  ...
  backendUrl: options.backendUrl || import.meta.env.VITE_WS_URL || import.meta.env.VITE_API_BASE_URL || (typeof window !== 'undefined' ? window.location.origin.replace(/^http/, 'ws') : '') || 'http://localhost:5000',
